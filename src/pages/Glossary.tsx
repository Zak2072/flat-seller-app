...
import { ChevronLeft, BookOpen, ExternalLink, MapPin, FileText, BadgePoundSterling, ShieldAlert, Info, Users, Send, Signature, FileSearch } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <main className="max-w-5xl mx-auto p-6 md:p-12 space-y-12">
        ...
        <div className="space-y-8 max-h-[70vh] overflow-y-auto hide-scrollbar pr-2">
          <GlossaryTerm 
          ...
          <GlossaryTerm 
            ...
            whereToGet="Drafted by the buyer's solicitor during the conveyancing process for the new owner to sign."
            whyNeeded="A legally binding document that establishes a direct contractual relationship between the buyer and the landlord, ensuring all lease covenants are observed."
            ifAbsent="This is a buyer-side dependency. Without it, the post-completion registration cannot occur, and the transfer may not be officially recognized."
          />
          ...
          <GlossaryTerm 
            id="licence-to-assign"
            title="Licence to Assign"
            icon={<FileSearch size={24} />}
            whereToGet="Formally granted by the landlord or freeholder via their solicitor or managing agent."
            whyNeeded="The landlord's formal written consent permitted for the current leaseholder to transfer the lease to a new buyer."
            ifAbsent="This is a critical seller-side document. The seller handles the managing agent's upfront fees to obtain this consent. Without it, the sale is a breach of lease."
          />
